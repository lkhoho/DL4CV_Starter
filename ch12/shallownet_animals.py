...
# partition the data into training and testing splits using 75% of the data for training and the
...
plt.plot(np.arange(0, 100), H.history['val_accuracy'], label='validation_acc')
