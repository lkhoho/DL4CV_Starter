...
class NeuralNetwork(object):
    def __init__(self, layers: list[int], alpha: float = 0.1):
        """
        Initialize the list of weights matrices, then store the network architecture and learning rate.
        
        :param layers: A list of integers which represents the actual architecture of the feedforward network. e.g.
    ...
    def fit_partial(self, x, y):
        """
        Performs feed-forward to predict, and back-propagation to train weights.
        ...
        # the first phase of back-propagation is to compute the \
    ...
    def predict(self, X, addBias=True):
        ...
        :param addBias: A boolean indicating whether we need to add a \
                        column of 1's to X to perform the bias trick.
        """
